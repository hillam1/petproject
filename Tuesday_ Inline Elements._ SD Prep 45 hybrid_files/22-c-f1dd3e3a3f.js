...
return Object(r["a"])(Object(r["a"])({},d),{},{body_class:null!==(t=window.ENV.FEATURES)&&void 0!==t&&t.canvas_k6_theme||window.ENV.K5_SUBJECT_COURSE||window.ENV.K5_HOMEROOM_COURSE?"elementary-theme":"default-theme",selector:"#"+this.idAttribute,[!u&&"toolbar"]:this.toolbar(),[!u&&"theme"]:"modern",[!u&&"skin"]:false,directionality:Object(l["b"])(),plugins:u?i:"autolink,media,paste,table,lists,textcolor,link,directionality,a11y_checker,wordcount,instructure_image,instructure_links,instructure_equation,instructure_external_tools,instructure_record",content_css:window.ENV.url_to_what_gets_loaded_inside_the_tinymce_editor_css,menubar:!u||void 0,init_instance_callback:e=>{$("#tinymce-parent-of-"+e.id).css("visibility","visible")},show_media_upload:!!INST.kalturaSettings&&!INST.kalturaSettings.hide_rte_button})}external_buttons(){let e=""
...
function g(e,t,i){const a=Object(r["a"])({},i)
e.forEach(e=>{const r=t[e]
const n=i[e]
Array.isArray(r)&&Array.isArray(n)&&(a[e]=[...new Set(r.concat(n))])})
return a}function f(e,t,a,n,o){const s=new h(o,_["a"],e,t)
const l=Object(r["a"])(Object(r["a"])({},s.defaultConfig()),{},{setup:e=>{ENV.use_rce_enhancements||e.on("init",()=>{const t=e=>e.default?e.default:e
const r=t(i("BdLV"))
new r(e).accessiblize()})}})
return Object(r["a"])(Object(r["a"])({},l),g(a.optionsToMerge||[],l,a.tinyOptions))}var p=f
var m=i("An8g")
var b=i("HGxv")
var k=i("8WeW")
...
a=r.canvas_icon_class?`<i class='${Object(y["a"])(r.canvas_icon_class)}' data-tool-id='${r.id}'></i>`:`<img src='${Object(y["a"])(r.icon_url)}' data-tool-id='${r.id}'/>`
a+="&nbsp;"+Object(y["a"])(r.name)
e[a]=function(){i(r,t)}
...
var T=i("dDTa")
var E=i("eodz")
const S=function(e,t){this.id=e.id
...
const B=["instructure_scribd_file"]
const j=new WeakMap
...
e.dialog("close")
t.createLink(o,l,c)
r.call()}))}function O(e){const t=R(e)
const i=t.getEditor()
...
Object(z["a"])(n()(this).data("service").service,e=>{n()("#instructure_link_prompt").dialog("close")
Object(E["d"])(t,"create_link",{title:e.title,url:e.url,classes:a})})}))
i.append(s)
...
d=new RegExp("("+B.join("|")+")");(c.attr("class")||"").match(d)&&r.addClass("for_inline_content_can_auto_show").find(".auto_show").show()
...
r.dialog({width:425,height:"auto",title:"Link to Website URL",open(){n()(this).find(".prompt").focus().select()}})}function D(e,t){D.counter=D.counter||0
true==t&&0!=D.counter?D.counter=(D.counter+1)%5:n()(e.getBody()).find("a").each((function(){const e=new A
const t=n()(this)
...
t.text()===t.attr("href")&&i<1&&e.titleYouTubeText(t)}}))}function V(e){if(j.get(e)||void 0===e.on)return
...
j.set(e,true)}var I={buttonToImg:L,prepEditorForDialog:R,buildLinkClasses:P,bindLinkSubmit:N,renderDialog:O,updateLinks:D,initEditor:V}
i("q1tI")
var q=i("i8i4")
var M=i.n(q)
...
Promise.all([i.e(1),i.e(3),i.e(4),i.e(6),i.e(17),i.e(607)]).then(i.bind(null,"PrO8")).then(({default:t})=>{const i=document.createElement("div")
document.body.appendChild(i)
M.a.render(Object(m["a"])(t,{win:window,editor:e,contextAssetString:ENV.context_asset_string,iframeAllowances:Object(T["a"])(),resourceSelectionUrl:n()("#context_external_tool_resource_selection_url").attr("href"),deepLinkingOrigin:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN}),i,(function(){a=this}))})
const o=[]
const s=[]
...
J(e,s)
Y(e,s)
W(e,s)}if(o.length){const t=function(){const t=x.clumpedButtonMapping(o,e,e=>a.open(e))
x.attachClumpedDropdown(n()("#"+this._id),t,e)}
...
function U(e,t){if(!t.iconSVG&&t.image){const e=document.createElement("svg")
...
t.icon="lti_tool_"+t.id}t.iconSVG&&e.ui.registry.addIcon(t.icon,t.iconSVG)}function W(e,t){t.length&&e.ui.registry.addNestedMenuItem("lti_tools_menuitem",{text:v.t("Apps"),icon:"lti",getSubmenuItems:()=>Z(e,t)})}function K(e,t){const i=v.t("Apps")
...
document.addEventListener("tinyRCE/initEquation",({detail:t})=>{Promise.all([i.e(7),i.e(652)]).then(i.bind(null,"dIBj")).then(({default:i})=>{const r=new i(t.ed)
e.equationCB(r)})})
document.addEventListener("tinyRCE/initLinks",({detail:t})=>{I.renderDialog(t.ed)
e.linksCB()})
document.addEventListener("tinyRCE/initImagePicker",t=>{Promise.all([i.e(1),i.e(7),i.e(8),i.e(9),i.e(24),i.e(85),i.e(79),i.e(90),i.e(605)]).then(i.bind(null,"FfTR")).then(({default:i})=>{const r=new i(t.detail.ed,t.detail.selectedNode)
e.imagePickerCB(r)})})
document.addEventListener("tinyRCE/initEquella",t=>{i.e(720).then(i.bind(null,"IOhY")).then(({default:i})=>{i(t.detail.ed)
e.equellaCB()})})
document.addEventListener("tinyRCE/initExternalTools",t=>{Q.init(t.detail.ed,t.detail.url,_["a"])
e.externalToolCB()})
document.addEventListener("tinyRCE/initRecord",t=>{Promise.all([i.e(45),i.e(721)]).then(i.bind(null,"lUrZ")).then(({default:i})=>{i.insertEditor(t.detail.ed)
...
var ae=i("ODXe")
var ne=i("BrAc")
function oe(e){let t=e
let i=null
return e=>{null===i&&(i=ne["a"].post("/api/v1/jwts/refresh",{jwt:t}).then(e=>{i=null
t=e.data.token
return t}))
"function"===typeof e&&i.then(e)
return i}}var se=i("s9Pr")
function le(){if(!ENV.context_asset_string)return null
let e=Object(se["a"])(ENV.context_asset_string,false),t=Object(ae["a"])(e,2),i=t[0],r=t[1]
...
if(!o||"account"===i){r=a
i="user"}return{canUploadFiles:ENV.RICH_CONTENT_CAN_UPLOAD_FILES,containingContext:n,contextType:i,contextId:r,filesTabDisabled:ENV.RICH_CONTENT_FILES_TAB_DISABLED,host:ENV.RICH_CONTENT_APP_HOST,jwt:ENV.JWT,refreshToken:oe(ENV.JWT),themeUrl:ENV.active_brand_config_json_url}}var ce=i("stQK")
let de
const ue={preload(e){(window.requestIdleCallback||window.setTimeout)(()=>this.loadRCE(e))},loadOnTarget(e,t,i){const r=this.getTargetTextarea(e)
const a=this.getRenderingTarget(r,t.getRenderingTarget)
const n=this.createRCEProps(r,t)
this.loadRCE(e=>{e.renderIntoDiv(a,n,e=>{e.mceInstance().on("init",()=>i(r,re.wrapEditor(e)))})})},loadSidebarOnTarget(e,t){if(ENV.RICH_CONTENT_SKIP_SIDEBAR)return
const i=le()
this.loadRCE(r=>{r.renderSidebarIntoDiv(e,i,e=>{t(re.wrapSidebar(e))})})},loadingCallbacks:[],RCE:null,loadRCE(e=(()=>{})){de||(de=(window.ENV.use_rce_enhancements?Promise.all([i.e(1),i.e(3),i.e(4),i.e(5),i.e(6),i.e(9),i.e(10),i.e(13),i.e(20),i.e(21),i.e(25),i.e(37),i.e(42),i.e(61),i.e(76),i.e(83),i.e(88),i.e(96),i.e(114),i.e(279)]).then(i.bind(null,"j/Fk")):Promise.all([i.e(1),i.e(3),i.e(4),i.e(5),i.e(10),i.e(11),i.e(12),i.e(13),i.e(20),i.e(25),i.e(28),i.e(37),i.e(42),i.e(61),i.e(76),i.e(73),i.e(77),i.e(86),i.e(280)]).then(i.bind(null,"dHiD"))).then(e=>{this.RCE=e
X()
return e}))
return de.then(()=>{this.loadingCallbacks.forEach(e=>e(this.RCE))
...
const u=ENV.LOCALE
const h=Object.keys(ce["a"]).map(e=>({id:e,label:ce["a"][e]})).sort((e,t)=>e.id===u?-1:t.id===u?1:e.label.localeCompare(t.label,u))
const _={enabled:ENV.use_rce_enhancements&&ENV.rce_auto_save,maxAge:Number.isNaN(ENV.rce_auto_save_max_age_ms)?36e5:ENV.rce_auto_save_max_age_ms}
return{defaultContent:e.value||t.defaultContent,editorOptions:p.bind(null,c,e.id,t,null),language:ENV.LOCALE,mirroredAttrs:this._attrsToMirror(e),onFocus:t.onFocus,onBlur:t.onBlur,textareaClassName:e.className,textareaId:e.id,trayProps:le(),languages:h,liveRegion:()=>document.getElementById("flash_screenreader_holder"),ltiTools:null===(i=window.INST)||void 0===i?void 0:i.editorButtons,autosave:_,instRecordDisabled:ENV.RICH_CONTENT_INST_RECORD_TAB_DISABLED,highContrastCSS:null===(a=window.ENV)||void 0===a?void 0:a.url_for_high_contrast_tinymce_editor_css,use_rce_pretty_html_editor:!!(null!==(n=window.ENV)&&void 0!==n&&null!==(o=n.FEATURES)&&void 0!==o&&o.rce_pretty_html_editor),use_rce_buttons_and_icons:!!(null!==(s=window.ENV)&&void 0!==s&&null!==(l=s.FEATURES)&&void 0!==l&&l.rce_buttons_and_icons)}}}
t["a"]=ue}}])

//# sourceMappingURL=22-c-f1dd3e3a3f.js.map